...
const updatePasswordController = async (req, res) => {
  try {
    ...
    user.user_password = hashedNewPass;
    await user.save();
...
const updateProfileController = async (req, res) => {
  try {
    ...
    // New profile image
    if (req.file) {
      updateData.user_profileImage = req.file.filename;
    }
    ...
    const updatedUser = await userTable.findByIdAndUpdate(
      ...
      "user_name user_email user_phone user_age user_height user_weight user_profileImage"
    );
